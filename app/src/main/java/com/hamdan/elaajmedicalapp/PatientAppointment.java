...
public class PatientAppointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.patientAppointmentsToolbar);
...
//        //4-Making the home button in toolbar
        ...
        final PatientAppointmentAdapter adapter = new PatientAppointmentAdapter(getSupportFragmentManager(),this,tabLayout.getTabCount());
