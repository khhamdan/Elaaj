...
public class PaymentOfPhysicalAppointment extends AppCompatActivity {
    IpAddress ipAddress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.payment_of_physical_appointment);
...
//        linearLayout = findViewById(R.id.linearList);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(PaymentOfPhysicalAppointment.this);
...
//                Toast.makeText(PatientAppointmentDetails.this, error.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void patientWalletPayment() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url4, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Toast.makeText(PaymentOfPhysicalAppointment.this, response, Toast.LENGTH_SHORT).show();
                Intent i = new Intent(getApplicationContext(), PatientPhysicalAppointment.class);
