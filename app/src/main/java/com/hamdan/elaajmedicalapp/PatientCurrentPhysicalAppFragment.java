...
import com.hamdan.elaajmedicalapp.adapter.PatientCurrentPhysicalAppAdapter;
...
public class PatientCurrentPhysicalAppFragment extends Fragment {
    IpAddress ipAddress;
    String url = "http://" + ipAddress.ip + ":8000/api/showPatientCurrentPhysicalAppointments";
    ...
    PatientCurrentPhysicalAppAdapter patientCurrentPhysicalAppAdapter;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.patient_current_physical_app, container, false);
        user_detailsList = new ArrayList<>();
        doctor_detailsList = new ArrayList<>();
        appointmentsList = new ArrayList<>();
        recyclerView = root.findViewById(R.id.currentPhysicalAppointmentRecyclerview);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        swipeRefreshLayout = root.findViewById(R.id.swipeRefreshCurrentPhysicalAppointments);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                getAppointmentList();
                getAppointmentList();
                patientCurrentPhysicalAppAdapter.notifyDataSetChanged();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < appointmentsDetails.length(); i++) {
                        ...
                        patientCurrentPhysicalAppAdapter =new PatientCurrentPhysicalAppAdapter(getActivity(), appointmentsList, user_detailsList, doctor_detailsList, new PatientCurrentPhysicalAppAdapter.ItemClickListener() {
                            @Override
                        ...
                        recyclerView.setAdapter(patientCurrentPhysicalAppAdapter);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
