...
import com.hamdan.elaajmedicalapp.adapter.DoctorCurrentPhysicalAppointmentAdapter;
import com.hamdan.elaajmedicalapp.adapter.DoctorTodayPhysicalAppointmentAdapter;
...
public class DoctorTodayPhysicalAppointmentFragment extends Fragment {

    IpAddress ipAddress;
    String url = "http://" + ipAddress.ip + ":8000/api/showTodayPhysicalDoctorAppointments";
    ...
    DoctorTodayPhysicalAppointmentAdapter doctorTodayPhysicalAppointmentAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.doctor_today_physical_app, container, false);


        user_detailsList = new ArrayList<>();
        appointmentsList = new ArrayList<>();
        paymentsList = new ArrayList<>();
        recyclerView = root.findViewById(R.id.doctorTodayPhysicalAppointmentRecyclerview);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        swipeRefreshLayout = root.findViewById(R.id.swipeRefreshDoctorTodayPhysicalAppointments);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                getAppointmentList();
                getAppointmentList();
                doctorTodayPhysicalAppointmentAdapter.notifyDataSetChanged();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < appointmentsDetails.length(); i++) {
                        ...
                        doctorTodayPhysicalAppointmentAdapter = new DoctorTodayPhysicalAppointmentAdapter(getActivity(), appointmentsList, user_detailsList, paymentsList, new DoctorTodayPhysicalAppointmentAdapter.ItemClickListener() {
                            @Override
                        ...
                        recyclerView.setAdapter(doctorTodayPhysicalAppointmentAdapter);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    private void sendEmail2(String userEmailInput,String patientName) {
        try {
            ...
            mimeMessage.setSubject("Subject: Elaaj Appointments");
            mimeMessage.setText("Dear "+patientName+", \n\n Your appointment have been cancelled by the "+doctorsName+"  \n\n Regards !\nElaaj");
