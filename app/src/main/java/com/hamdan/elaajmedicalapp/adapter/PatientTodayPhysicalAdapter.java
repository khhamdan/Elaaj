...
public class PatientTodayPhysicalAdapter extends RecyclerView.Adapter<PatientTodayPhysicalAdapter.ViewHolder>{
    Context context;
    ...
    public PatientTodayPhysicalAdapter(Context context, List<Appointments> appointmentsArrayList, List<User_Details> user_detailsList, List<Doctor_Details> arrayListDoctors, ItemClickListener mItemListener) {
    ...
    @NonNull
    @Override
    public PatientTodayPhysicalAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.patient_today_physical_appointment, parent, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull PatientTodayPhysicalAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
