...
public class PatientAppointmentsListAdapter extends RecyclerView.Adapter<PatientAppointmentsListAdapter.ViewHolder> {
    Context context;
    ...
    public PatientAppointmentsListAdapter(Context context, List<Appointments> appointmentsArrayList, List<User_Details> user_detailsList, List<Doctor_Details> arrayListDoctors) {
    ...
    {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.my_appointment_list, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.viewAppointmentDetail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), PatientAppointmentDetails.class);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        AppCompatButton viewAppointmentDetail;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            viewAppointmentDetail = itemView.findViewById(R.id.viewAppointmentDetail);
