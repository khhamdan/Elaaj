...
public class DoctorsTodayOnlineAppointmentAdapter extends RecyclerView.Adapter<DoctorsTodayOnlineAppointmentAdapter.ViewHolder>{
    Context context;
    ...
    public DoctorsTodayOnlineAppointmentAdapter(Context context, List<Appointments> appointmentsArrayList, List<User_Details> user_detailsList, List<Payments> paymentsArrayList, ItemClickListener mItemListener) {
    ...
    @NonNull
    @Override
    public DoctorsTodayOnlineAppointmentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.doctor_today_appointment_list, parent, false);
        return new DoctorsTodayOnlineAppointmentAdapter.ViewHolder(view);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull DoctorsTodayOnlineAppointmentAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
