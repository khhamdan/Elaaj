...
public class DoctorCurrentPhysicalAppointmentAdapter extends RecyclerView.Adapter<DoctorCurrentPhysicalAppointmentAdapter.ViewHolder>{
    Context context;
    ...
    public DoctorCurrentPhysicalAppointmentAdapter(Context context, List<Appointments> appointmentsArrayList, List<User_Details> user_detailsList, List<Payments> paymentsArrayList, ItemClickListener mItemListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.doctor_current_physical_appointment_list, parent, false);
