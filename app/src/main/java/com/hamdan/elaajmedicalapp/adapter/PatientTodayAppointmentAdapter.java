...
public class PatientTodayAppointmentAdapter extends RecyclerView.Adapter<PatientTodayAppointmentAdapter.ViewHolder>{
    ...
    public PatientTodayAppointmentAdapter(Context context, List<Appointments> appointmentsArrayList, List<User_Details> user_detailsList, List<Doctor_Details> arrayListDoctors, ItemClickListener mItemListener) {
    ...
    {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.patient_today_appointment_list, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        AppCompatButton cancelAppointment,my_prescription_btn;
