...
import com.hamdan.elaajmedicalapp.adapter.PatientPreviousPhysicalAppointmentAdapter;
...
public class PatientPreviousPhysicalAppFragment extends Fragment {

    IpAddress ipAddress;
    String url="http://"+ipAddress.ip+":8000/api/showPatientPreviousPhysicalAppointments";
    ...
    PatientPreviousPhysicalAppointmentAdapter patientPreviousPhysicalAppointmentAdapter;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.patient_previous_physical_app, container, false);

        user_detailsList = new ArrayList<>();
        doctor_detailsList = new ArrayList<>();
        appointmentsList = new ArrayList<>();
        recyclerView = root.findViewById(R.id.previousPhysicalAppointmentRecyclerview);
        ...
        swipeRefreshLayout = root.findViewById(R.id.swipeRefreshPreviousPhysicalAppointments);

        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                getAppointmentList();
                patientPreviousPhysicalAppointmentAdapter.notifyDataSetChanged();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < appointmentsDetails.length(); i++) {
                        ...
                        patientPreviousPhysicalAppointmentAdapter = new PatientPreviousPhysicalAppointmentAdapter(getActivity(), appointmentsList, user_detailsList, doctor_detailsList);
                        recyclerView.setAdapter(patientPreviousPhysicalAppointmentAdapter);
