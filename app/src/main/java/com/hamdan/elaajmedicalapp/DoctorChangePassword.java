...
public class DoctorChangePassword extends AppCompatActivity {
    ...
    IpAddress ipAddress;
    private EditText current_password,new_password,new_password_again;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.toolbar_doctor_change_password);
        toolbar.setTitle("Doctor Change Password");
        ...
        changePassword_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(DoctorChangePassword.this, "Password don't match" , Toast.LENGTH_SHORT).show();;
                }
            }
        });
    ...
    public void changePassword()
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response)
            {
                ...
                Intent intent = new Intent(DoctorChangePassword.this,DoctorProfile.class);
