...
import com.hamdan.elaajmedicalapp.Sugession.DocumentMimtype;
...
//    Uri uri= Uri.parse("content://com.android.providers.downloads.documents/document/raw%3A%2Fstorage%2Femulated%2F0%2FDownload%2Fblank1.png")
    ...
    ArrayList<DocumentMimtype> documentMimetypeList = new ArrayList();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.patient_prescriptions);
...
//                intent.setType("application/pdf");
        ...
        skipBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent skipIntent = new Intent(PatientPrescriptions.this,BookAppointment.class);
...
//                                Toast.makeText(getApplicationContext(), error.getMessage(), Toast.LENGTH_SHORT).show();
                ...
                rQueue = Volley.newRequestQueue(PatientPrescriptions.this);
