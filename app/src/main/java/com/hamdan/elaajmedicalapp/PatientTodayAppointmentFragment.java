...
public class PatientTodayAppointmentFragment extends Fragment {


    IpAddress ipAddress;
    String url = "http://" + ipAddress.ip + ":8000/api/showPatientTodayAppointments";
    ...
    PatientTodayAppointmentAdapter patientTodayAppointmentAdapter;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_patient_today_appointment, container, false);

        user_detailsList = new ArrayList<>();
        doctor_detailsList = new ArrayList<>();
        appointmentsList = new ArrayList<>();
        recyclerView = root.findViewById(R.id.todayAppointmentRecyclerview);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        swipeRefreshLayout = root.findViewById(R.id.swipeRefreshTodayAppointments);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                getTodayAppointmentList();
                getTodayAppointmentList();
                patientTodayAppointmentAdapter.notifyDataSetChanged();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < appointmentsDetails.length(); i++) {
                        ...
                        patientTodayAppointmentAdapter =new PatientTodayAppointmentAdapter(getActivity(), appointmentsList, user_detailsList, doctor_detailsList, new PatientTodayAppointmentAdapter.ItemClickListener() {
                            @Override
                        ...
                        recyclerView.setAdapter(patientTodayAppointmentAdapter);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
