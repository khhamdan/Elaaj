...
public class PatientSymptomsPhysicalAppointment extends AppCompatActivity {
    String symptoms;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.patient_symptoms_physical_appointment);
    ...
    public void postPatientSymptoms() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url3, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                Toast.makeText(PatientSymptomsPhysicalAppointment.this, response, Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getApplicationContext(), PaymentOfPhysicalAppointment.class);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(PatientSymptomsPhysicalAppointment.this);
...
//                        symptomsSpinner.setAdapter(symptomsAdapter);
                    ...
                    symptomsTexts.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(PatientSymptomsPhysicalAppointment.this);
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(PatientSymptomsPhysicalAppointment.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }) {
            @Nullable
            @Override
