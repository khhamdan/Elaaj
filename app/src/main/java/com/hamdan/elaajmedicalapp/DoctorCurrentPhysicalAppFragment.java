...
import com.hamdan.elaajmedicalapp.adapter.DoctorsTodayOnlineAppointmentAdapter;
...
public class DoctorCurrentPhysicalAppFragment extends Fragment {

    IpAddress ipAddress;
    String url = "http://" + ipAddress.ip + ":8000/api/showCurrentPhysicalDoctorAppointments";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.doctor_current_physical_app, container, false);

        user_detailsList = new ArrayList<>();
        appointmentsList = new ArrayList<>();
        paymentsList = new ArrayList<>();
        recyclerView = root.findViewById(R.id.currentDoctorPhysicalAppointmentRecyclerview);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        swipeRefreshLayout = root.findViewById(R.id.swipeRefreshCurrentPhysicalDoctorAppointments);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                getAppointmentList();
                getAppointmentList();
                doctorCurrentPhysicalAppointmentAdapter.notifyDataSetChanged();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < appointmentsDetails.length(); i++) {
                        ...
                        doctorCurrentPhysicalAppointmentAdapter = new DoctorCurrentPhysicalAppointmentAdapter(getActivity(), appointmentsList, user_detailsList, paymentsList, new DoctorCurrentPhysicalAppointmentAdapter.ItemClickListener() {
                            @Override
                        ...
                        recyclerView.setAdapter(doctorCurrentPhysicalAppointmentAdapter);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
