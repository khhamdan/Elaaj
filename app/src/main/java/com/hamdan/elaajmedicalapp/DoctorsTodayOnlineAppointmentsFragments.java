...
public class DoctorsTodayOnlineAppointmentsFragments extends Fragment {

    IpAddress ipAddress;
    String url = "http://" + ipAddress.ip + ":8000/api/showTodayDoctorAppointments";
    ...
    DoctorsTodayOnlineAppointmentAdapter doctorsTodayOnlineAppointmentAdapter;


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.doctors_today_online_appointments, container, false);

        user_detailsList = new ArrayList<>();
        appointmentsList = new ArrayList<>();
        paymentsList = new ArrayList<>();
        recyclerView = root.findViewById(R.id.doctorTodayAppointmentRecyclerview);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        swipeRefreshLayout = root.findViewById(R.id.swipeRefreshDoctorTodayAppointments);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                getAppointmentList();
                getAppointmentList();
                doctorsTodayOnlineAppointmentAdapter.notifyDataSetChanged();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < appointmentsDetails.length(); i++) {
                        ...
                        doctorsTodayOnlineAppointmentAdapter = new DoctorsTodayOnlineAppointmentAdapter(getActivity(), appointmentsList, user_detailsList, paymentsList, new DoctorsTodayOnlineAppointmentAdapter.ItemClickListener() {
                            @Override
                        ...
                        recyclerView.setAdapter(doctorsTodayOnlineAppointmentAdapter);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
