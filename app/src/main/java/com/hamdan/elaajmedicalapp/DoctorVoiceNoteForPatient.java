...
public class DoctorVoiceNoteForPatient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.doctor_voice_note_for_patient);
        ...
        Toolbar toolbar = findViewById(R.id.voice_note_toolbar);
